...
var BLOCKSCOUT_TYPES = new Map([['block', 'block'], ['transaction', 'tx'], ['address', 'address'], ['token', 'token']]);
var BLOCK_EXPLORERS = {
...
function blockExplorerUrl(type, value) {
  var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      _ref3$networkType = _ref3.networkType,
      networkType = _ref3$networkType === void 0 ? 'xdai' : _ref3$networkType,
      _ref3$provider = _ref3.provider,
      provider = _ref3$provider === void 0 ? 'blockscout' : _ref3$provider;
